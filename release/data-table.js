...
System.register("npm:angular@1.4.0/angular", ["github:jspm/nodelibs-process@0.1.1"], true, function(require, exports, module) {
  var global = System.global,
      __define = global.define;
  global.define = undefined;
  (function(process) {
...
System.register("npm:angular@1.4.0/index", ["npm:angular@1.4.0/angular"], true, function(require, exports, module) {
  var global = System.global,
      __define = global.define;
  global.define = undefined;
  require("npm:angular@1.4.0/angular");
  module.exports = angular;
  global.define = __define;
  return module.exports;
});

System.register("npm:angular@1.4.0", ["npm:angular@1.4.0/index"], true, function(require, exports, module) {
  var global = System.global,
      __define = global.define;
  global.define = undefined;
  module.exports = require("npm:angular@1.4.0/index");
  global.define = __define;
  return module.exports;
});
      ...
      DataTableController = (function() {
        ...
        _createClass(DataTableController, [{
          ...
          value: function transposeColumnDefaults(columns) {
            ...
            var _iteratorError = undefined;
            try {
              for (var _iterator = columns.entries()[Symbol.iterator](),
                  _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
(".dt,.dt .dt-row-center,.dt .dt-row-left,.dt .dt-row-right{position:relative}.dt{justify-content:center}.dt *,.dt :after,.dt :before{-moz-box-sizing:border-box;-webkit-box-sizing:border-box;box-sizing:border-box}.dt .dt-clone{opacity:.4}.dt .dt-clone .dt-resize-handle{visibility:hidden}.dt .dt-cell,.dt .dt-header-cell{vertical-align:top;overflow:hidden;white-space:nowrap;line-height:1.625;text-overflow:ellipsis;touch-callout:none;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;-o-user-select:none;user-select:none}.dt .dt-header-inner,.dt .dt-row{display:-webkit-box;display:-moz-box;display:-ms-flexbox;display:-webkit-flex;display:flex;flex-direction:row;-webkit-flex-flow:row;-moz-flex-flow:row;-ms-flex-flow:row;-o-flex-flow:row;flex-flow:row}.dt .dt-row-left,.dt .dt-row-right{z-index:9}.dt .dt-header{overflow:hidden}.dt .dt-header .dt-header-inner{white-space:nowrap;align-items:stretch;-webkit-align-items:stretch}.dt .dt-header .dt-header-cell{position:relative;white-space:nowrap;display:inline-block}.dt .dt-header .dt-header-cell.dt-drag-over{background:#EEE}.dt .dt-header .dt-header-cell.sortable .dt-header-cell-label{cursor:pointer}.dt .dt-header .dt-header-cell .sort-btn{visibility:hidden;display:inline-block}.dt .dt-header .dt-header-cell .sort-btn.sort-asc,.dt .dt-header .dt-header-cell .sort-btn.sort-desc{visibility:visible}.dt .dt-header .dt-header-cell .dt-resize-handle{display:inline-block;position:absolute;right:0;top:0;bottom:0;width:5px;padding:0 5px;border-right:solid 1px #eee;visibility:hidden;cursor:ew-resize}.dt .dt-header .dt-header-cell.resizable:hover .dt-resize-handle{visibility:visible}.dt .dt-header .dt-header-cell:last-child .dt-resize-handle{visibility:hidden!important}.dt .dt-body{overflow:auto;position:relative;z-index:10}.dt .dt-body .dt-body-scroller{white-space:nowrap}.dt .dt-body .dt-group-row{outline:0}.dt .dt-body .dt-row{backface-visibility:hidden;outline:0;white-space:nowrap}.dt .dt-body .dt-row>div{display:-webkit-box;display:-moz-box;display:-ms-flexbox;display:-webkit-flex;display:flex}.dt .dt-body .dt-tree-toggle{cursor:pointer}.dt .dt-footer .page-count{display:inline-block}.dt .dt-footer .pagination,.dt .dt-footer .pagination li{padding:0;margin:0;list-style:none}.dt .dt-footer .pagination{display:inline-block;float:right}.dt .dt-footer .pagination li,.dt .dt-footer .pagination li a{display:inline-block;outline:0}.dt.fixed .dt-body .dt-group-row,.dt.fixed .dt-body .dt-row{position:absolute;top:0}");