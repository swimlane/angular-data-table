# angular-data-table [![Join the chat at https://gitter.im/Swimlane/angular-data-table](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/Swimlane/angular-data-table?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge) [![Dependency Status](https://david-dm.org/swimlane-contrib/angular-data-data.svg)](https://david-dm.org/Swimlane/angular-data-data) [![devDependency Status](https://david-dm.org/swimlane-contrib/angular-data-data/dev-status.svg)](https://david-dm.org/Swimlane/angular-data-data#info=devDependencies)
